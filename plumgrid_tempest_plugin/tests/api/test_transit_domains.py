...
class TestTransitDomains(base.BaseTest):
    ...
    @decorators.idempotent_id('29a30571-2f4c-4bc6-87c4-6f8052e04f93')
    ...
    @test.attr(type='smoke')
    @decorators.idempotent_id('9ff01991-a7df-4a1e-b2e9-5bc0f5dc21fb')
    ...
    @test.attr(type='smoke')
    @decorators.idempotent_id('89b2e4be-1cae-4a88-b6e3-8c100ceebba5')
    ...
    @test.attr(type='smoke')
    @decorators.idempotent_id('61390bee-9d9a-4728-bcfc-439c112c061e')
    ...
    @test.attr(type='smoke')
    @decorators.idempotent_id('0f2cc7dc-049b-43fa-a7b0-41c044bcc09f')
