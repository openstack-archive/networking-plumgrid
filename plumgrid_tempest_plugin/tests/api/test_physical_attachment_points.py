...
class TestPhysicalAttachmentPoint(base.BaseTest):
    ...
    @decorators.idempotent_id('2fb95a42-482d-45cd-93fd-9e161a709874')
    ...
    @test.attr(type='smoke')
    @decorators.idempotent_id('5d4b2eb6-5ce6-44c3-afb3-b0fb75a15c7c')
    ...
    @test.attr(type='smoke')
    @decorators.idempotent_id('3ba5892a-5fb1-49fc-b113-1e3b47712a37')
    ...
    @test.attr(type='smoke')
    @decorators.idempotent_id('3f817924-7ca0-41a3-bf30-ce00079a90d6')
    ...
    @test.attr(type='smoke')
    @decorators.idempotent_id('fb1e3803-2872-439a-bb4a-e3de50d3ed91')
