...
class TestPolicyTag(PolicyTagTestCase):
    def test_create_policy_tag_with_fip(self):
        ...
        subnet_ret = plugin.create_subnet(tenant_context, subnet)
    ...
    def test_create_update_policy_tag(self):
        ...
        ptag_update_dict["policy_tag"]["tag_type"] = \
                        ptag_update_ret["tag_type"]
        ptag_update_dict["policy_tag"]["router_id"] = \
                        ptag_update_ret["router_id"]
        ptag_update_dict["policy_tag"]["floatingip_id"] = \
                        ptag_update_ret["floatingip_id"]
        ptag_update_dict["policy_tag"]["floating_ip_address"] = \
                        ptag_update_ret["floating_ip_address"]
