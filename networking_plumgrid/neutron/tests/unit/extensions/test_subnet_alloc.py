...
"""
PLUMgrid plugin subnet allocation extension unit tests
"""
...
from neutron.tests.unit.ipam import test_subnet_alloc as suballoc
...
class SubnetAllocTestCase(suballoc.TestSubnetAllocation):
    ...
    def setUp(self):
        ...
        with mock.patch.object(plumgrid_plugin.NeutronPluginPLUMgridV2,
            ...
            super(SubnetAllocTestCase, self).setUp()

    def tearDown(self):
        super(SubnetAllocTestCase, self).tearDown()
