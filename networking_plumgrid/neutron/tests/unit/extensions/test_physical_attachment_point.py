...
class TestPhysicalAttachmentPoint(PhysicalAttachmentPointTestCase):
    ...
    def test_create_update_get_pap02(self):
        plugin = manager.NeutronManager.get_plugin()
        admin_context = context.get_admin_context()
    ...
    def test_create_update_get_pap03(self):
        plugin = manager.NeutronManager.get_plugin()
        admin_context = context.get_admin_context()
        ...
        pap_new = {"physical_attachment_point": {
                       ...
                       "lacp": False,
                       "interfaces": [
                           {"hostname": "test_host2", "interface": "ifc2"},
                           {"hostname": "test_host3", "interface": "ifc3"}]}}
    ...
    def test_create_get_pap02(self):
        plugin = manager.NeutronManager.get_plugin()
        admin_context = context.get_admin_context()
        pap = {"physical_attachment_point": {
                   "tenant_id": "test_tenant",
