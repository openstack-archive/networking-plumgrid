...
def upgrade():
    ...
    op.create_table(
        ...
        sa.Column('policy_service_id', sa.String(length=36), nullable=False),
        sa.Column('policy_service_chain_id', sa.String(length=36),
                  nullable=False),
    ...
    op.create_table(
        ...
        sa.Column('action_target_service_chain', sa.String(length=36),
                  nullable=True),
        ...
        sa.ForeignKeyConstraint(['action_target_service'],
                                ['pg_policy_services.id'],
                                ondelete='CASCADE'),
        sa.ForeignKeyConstraint(['action_target_service_chain'],
                                ['pg_policy_service_chains.id'],
                                ondelete='CASCADE'),
