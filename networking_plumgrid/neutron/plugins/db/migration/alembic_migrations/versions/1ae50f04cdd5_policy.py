...
def upgrade():
    op.create_table(
        ...
        sa.ForeignKeyConstraint(['floatingip_id'], ['floatingips.id'], ondelete='CASCADE'),
    ...
    op.create_table(
        ...
        sa.Column('tenant_id', sa.String(length=36), nullable=True),
        sa.ForeignKeyConstraint(['policy_tag_id'], ['pg_policy_tags.id'], ondelete='CASCADE'),
        sa.PrimaryKeyConstraint('id')
    )
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(['security_group_id'], ['securitygroups.id'], ondelete='CASCADE'),
    ...
    op.create_table(
        ...
        sa.Column('endpoint_group_id', sa.String(length=36), nullable=False),
        sa.ForeignKeyConstraint(['endpoint_id'], ['pg_endpoints.id'], ondelete='CASCADE'),
        sa.ForeignKeyConstraint(['endpoint_group_id'],
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(['policy_service_id'], ['pg_policy_services.id'], ondelete='CASCADE'),
        sa.ForeignKeyConstraint(['port_id'],
                                ['ports.id'], ondelete='CASCADE')
    )

    op.create_table(
        'pg_policy_service_chains',
        sa.Column('id', sa.String(length=36), nullable=False),
        sa.Column('name', sa.String(length=255), nullable=True),
        sa.Column('description', sa.String(length=1024), nullable=True),
        sa.Column('tenant_id', sa.String(length=36), nullable=True),
    ...
    op.create_table(
        'pg_policy_service_chain_binding',
        sa.Column('policy_service_id', sa.String(length=36), nullable=False),
        sa.Column('policy_service_chain_id', sa.String(length=36), nullable=False),
        sa.Column('index', sa.BigInteger(), autoincrement=True),
        sa.PrimaryKeyConstraint('index'),
        sa.ForeignKeyConstraint(['policy_service_id'], ['pg_policy_services.id'], ondelete='CASCADE'),
        sa.ForeignKeyConstraint(['policy_service_chain_id'],
                                ['pg_policy_service_chains.id'], ondelete='CASCADE')
    )
    ...
    op.create_table(
        ...
        sa.Column('action_target_service', sa.String(length=36), nullable=True),
        sa.Column('action_target_service_chain', sa.String(length=36), nullable=True),
        sa.Column('action_target_tenant_id', sa.String(length=36), nullable=True),
        ...
        sa.ForeignKeyConstraint(['dst_grp_sg'], ['securitygroups.id'],
                                ondelete='CASCADE'),
        sa.ForeignKeyConstraint(['action_target_service'], ['pg_policy_services.id'],
                                ondelete='CASCADE'),
        sa.ForeignKeyConstraint(['action_target_service_chain'], ['pg_policy_service_chains.id'],
                                ondelete='CASCADE'),
