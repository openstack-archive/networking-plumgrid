...
director_server_opts = [
    ...
    cfg.BoolOpt('distributed_locking', default=False,
...
class NeutronPluginPLUMgridV2(db_base_plugin_v2.NeutronDbPluginV2,
    ...
    def update_port(self, context, port_id, port):
        ...
        return self._update_port_pg(context, port_id, port, tenant_id)

    @pgl
    def _update_port_pg(self, context, port_id, port, tenant_id):
        ...
        with context.session.begin(subtransactions=True):
            ...
            int_router = super(NeutronPluginPLUMgridV2,
                               self).add_router_interface(context,
                                                          ...
                                                          interface_info)
            try:
                lock = pg_lock.PGLock(context, tenant_id)
            ...
            except plum_excep.TenantResourcesInUse:
                raise
