...
LOCAL = "local"
SUPPORTED_POLICY_TAG_TYPES = ["fip", "dot1q", "nsh"]
SUPPORTED_POLICY_RULE_PROTOCOLS = ["any", "tcp", "udp", "icmp"]
SUPPORTED_POLICY_RULE_ACTIONS = ['copy', 'allow', 'redirect']
DIRECTION_INGRESS = "ingress"
DIRECTION_EGRESS = "egress"
BIDIRECTIONAL = "bidirectional"
BINDING_VIF_TYPE_IOVISOR = "iovisor"
SP_TAG_TYPES = ["dot1q", "nsh"]
